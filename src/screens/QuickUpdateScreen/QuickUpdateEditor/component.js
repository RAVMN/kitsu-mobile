  ...
  render() {
    ...
    return (
      <PostCreator
        ...
        placeholder={I18n.t("screens.quickupdatescreen.editor.share", {number: progress})}
        spoiler
        hideMeta
        disableMedia
        ...
        renderHeader={(busy, isEditing, onPostPress, onCancelPress) => (
          <Animated.View style={[styles.header, { opacity: headerOpacity }]}>
            ...
            />
            <Text style={styles.headerText}>{I18n.t("screens.quickupdatescreen.editor.episode", {number: progress})}</Text>
            <HeaderButton
